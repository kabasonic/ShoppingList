...
public class ArchivingFragment extends Fragment {
    ...
    private ArchivingViewModel viewModel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.getAllArchivingShoppingListWithItems().observe(getViewLifecycleOwner(), new Observer<List<ShoppingListWithItems>>() {
            @Override
